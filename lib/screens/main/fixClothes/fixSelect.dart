  ...
  void cartDetailInfo() {
    setState(() {
      metadata = [
        ...
        WooOrderPayloadMetaData(key: '치수', value: texteditingController[0].text),
        WooOrderPayloadMetaData(key: '사진', value: ''),
        WooOrderPayloadMetaData(key: '물품 가액', value: texteditingController[1].text),
        WooOrderPayloadMetaData(key: '추가 설명', value: texteditingController[2].text),
        WooOrderPayloadMetaData(key: '추가 옵션', value: controller.radioGroup.toString()),
      ];
    });
  }
                ...
                FutureBuilder(
                    ...
                    builder: (context, snapshot) {
                      if (snapshot.connectionState == ConnectionState.done) {
                        ...
                        return variation.length != 0 ? Container(
                                child: Column(
                                    crossAxisAlignment:
                  ...
                  child: Container(
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        GestureDetector(
                          onTap: () {
                            if(texteditingController[0].text.length > 0 && texteditingController[1].text.length > 0 ) {
                          ...
                          child:
                              SvgPicture.asset("assets/icons/floatingNext.svg", color: texteditingController[0].text.length > 0 && texteditingController[1].text.length > 0 ? HexColor("#fd9a03") : HexColor("#d5d5d5"),),
                        ),
                      ],
                    ),
                  ),
      ...
      child: Column(children: [
        ...
        Container(
          ...
          child: TextField(
            ...
            inputFormatters: listName == "치수 입력" || listName == "물품 가액" ? [FilteringTextInputFormatter.allow(RegExp('[0-9.]'))] : null,
